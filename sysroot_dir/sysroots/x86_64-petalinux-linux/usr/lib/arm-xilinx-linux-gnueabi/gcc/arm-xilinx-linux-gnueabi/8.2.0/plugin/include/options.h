...
enum opt_code
{
  ...
  OPT_time = 1351,                           /* -time */
  OPT_time_ = 1352,                          /* -time= */
  OPT_tno_android_cc = 1353,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1354,                 /* -tno-android-ld */
  OPT_traditional = 1355,                    /* -traditional */
  OPT_traditional_cpp = 1356,                /* -traditional-cpp */
  OPT_trigraphs = 1357,                      /* -trigraphs */
  OPT_u = 1358,                              /* -u */
  OPT_undef = 1359,                          /* -undef */
  OPT_v = 1360,                              /* -v */
  OPT_version = 1361,                        /* -version */
  OPT_w = 1362,                              /* -w */
  OPT_wrapper = 1363,                        /* -wrapper */
  OPT_x = 1364,                              /* -x */
  OPT_z = 1365,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
